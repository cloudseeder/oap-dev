...
export const PERSONA_STYLES: Record<string, PersonaStyle> = {
  ...
  marvin: { shape: 'ellipse',  primary: '#6b7280', secondary: '#475569', bgGlow: 'rgba(107,114,128,0.1)', idleSpeed: 0.5, speakIntensity: 0.5, quirk: 'droop' },
  ...
  hal:    { shape: 'circle',   primary: '#dc2626', secondary: '#000000', bgGlow: 'rgba(220,38,38,0.2)',    idleSpeed: 0.3, speakIntensity: 0.5, quirk: 'none' },
