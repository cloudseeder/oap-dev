...
export const metadata: Metadata = {
  title: 'Protocol Specification — OAP',
  description: 'The full Open Application Protocol specification.',
}

export default async function SpecPage() {
  const content = readFileSync(join(process.cwd(), 'docs/SPEC.md'), 'utf-8')
