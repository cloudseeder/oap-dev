...
export const metadata: Metadata = {
  title: 'Registry Specification — OAP',
  description: 'The OAP Registry API specification.',
}

export default async function RegistrySpecPage() {
  const content = readFileSync(join(process.cwd(), 'docs/REGISTRY.md'), 'utf-8')
