...
export const metadata: Metadata = {
  title: 'Procedural Memory Paper — OAP',
...
export default async function ProceduralMemoryPage() {
  const content = readFileSync(join(process.cwd(), 'docs/OAP-PROCEDURAL-MEMORY-PAPER.md'), 'utf-8')
