...
export const metadata: Metadata = {
  title: 'Trust Overlay — OAP',
  description: 'Trust overlay specification: graduated attestation layers for OAP manifests.',
}

export default async function TrustDocPage() {
  const content = readFileSync(join(process.cwd(), 'docs/TRUST.md'), 'utf-8')
