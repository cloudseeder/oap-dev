...
export const metadata: Metadata = {
  title: 'OAP + Ollama — OAP',
  description: 'Manifest discovery as native Ollama tool calling via the tool bridge.',
}

export default async function OllamaPage() {
  const content = readFileSync(join(process.cwd(), 'docs/OLLAMA.md'), 'utf-8')
