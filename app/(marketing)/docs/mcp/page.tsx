...
export const metadata: Metadata = {
  title: 'MCP Server — OAP',
  description: 'Expose OAP manifest discovery to Claude Desktop, Claude Code, and MCP clients via a lightweight MCP server.',
}

export default async function MCPPage() {
  const content = readFileSync(join(process.cwd(), 'docs/MCP.md'), 'utf-8')
