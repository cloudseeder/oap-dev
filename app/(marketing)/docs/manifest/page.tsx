...
export const metadata: Metadata = {
  title: 'Manifest — OAP',
  description: 'A companion chat app with autonomous task execution, built on OAP manifest discovery.',
}

export default async function ManifestPage() {
  const content = readFileSync(join(process.cwd(), 'docs/MANIFEST.md'), 'utf-8')
