...
export const metadata: Metadata = {
  title: 'OpenAPI Tool Server — OAP',
  description: 'Expose OAP manifests as a standard OpenAPI 3.1 spec for Open WebUI, LangChain, and any OpenAPI-aware client.',
}

export default async function OpenAPIToolServerPage() {
  const content = readFileSync(join(process.cwd(), 'docs/OPENAPI-TOOL-SERVER.md'), 'utf-8')
