...
NEWSYSLOG_CONF="/etc/newsyslog.d/oap.conf"
echo "Configuring log rotation..."

NEWSYSLOG_CONTENT="# OAP service log rotation — generated by setup-mac-mini.sh
# logfile                              mode count size(KB) when  flags
/tmp/com.oap.discovery.log              644  3     5120     *     GN
/tmp/com.oap.discovery.err              644  3     5120     *     GN
/tmp/com.oap.trust.log                  644  3     5120     *     GN
/tmp/com.oap.trust.err                  644  3     5120     *     GN
/tmp/com.oap.dashboard.log              644  3     5120     *     GN
/tmp/com.oap.dashboard.err              644  3     5120     *     GN
/tmp/com.oap.agent.log                  644  3     5120     *     GN
/tmp/com.oap.agent.err                  644  3     5120     *     GN
/tmp/com.oap.crawler.log                644  3     5120     *     GN
/tmp/com.oap.crawler.err                644  3     5120     *     GN"

echo "  Writing $NEWSYSLOG_CONF (requires sudo)..."
echo "  Rotate at 5MB, keep 3 archives, gzip compressed."
echo "  G = gzip, N = don't signal (launchd reopens handles)."
echo "$NEWSYSLOG_CONTENT" | sudo tee "$NEWSYSLOG_CONF" > /dev/null
echo "  Created $NEWSYSLOG_CONF"
